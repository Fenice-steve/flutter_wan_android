...
class SearchBar extends StatefulWidget {
  ...
  SearchBar(
      {this.city, this.enabled = true, this.hideLeft, this.autofocus = false,
        this.searchBarType = SearchBarType
            .normal, this.hint, this.defaultText, this.leftButtonClick,
        this.rightButtonClick, this.speakClick, this.inputBoxClick,
        this.onChanged});
...
class _SearchBarState extends State<SearchBar> {
    ...
    return Container(
      child: Row(
        children: <Widget>[
          ...
          _wrapTap(Container(padding: EdgeInsets.fromLTRB(10, 5, 10, 5),
            child: Text(
  ...
  Widget get _genHomeSearch{
    return Container(
      ...
      _wrapTap(Container(
        ...
        child: Row(
          children: <Widget>[
            Text(widget.city,style: TextStyle(color: _homeFontColor, fontSize: 14),),Icon(Icons.expand_more, color: _homeFontColor, size: 22,)
          ],
        ),
      ), widget.leftButtonClick),
          Expanded(flex:1,child: _inputBox, ),_wrapTap(Container(padding: EdgeInsets.fromLTRB(10, 5, 10, 5),child: Icon(Icons.comment, color: _homeFontColor, size: 26,),), widget.rightButtonClick)
        ],
      ),
    );
  }
  ...
  Widget get _inputBox {
    ...
    if (widget.searchBarType == SearchBarType.home) {
      inputBoxColor = Colors.white.withOpacity(0.5);
    } else {
